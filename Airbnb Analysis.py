...
st.set_page_config(page_title="AirBnb-Analysis by Guttikonda Yoganand!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Users\yoganand\OneDrive\Desktop\Data Science\project 4-AirBnb")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Guttikonda Yoganand"}')
    mail = (f'{"Mail :"}  {"yoganand050@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Users\\yoganand\\OneDrive\\Desktop\\passpoer size photo.jpg"), width=300)
